...
12 cosmetic hero-skin unlocks + garage screen. Phase H1 (Security Gates)
🔶 in progress (`b325466`) — solver + rendering + test levels. Next: full
generation, then H2 (Alarm mode), H3 (Hitches), H4 (Bounties).
